package com.venuyeggadi.problemsolving.leetcode;/* Given an array arr of integers, check if there exists two integers N and M such
...
//#1 Bruteforce
//O(n^2), O(1)
class CheckIfNAndItsDoubleExistSolution1 {
...
//#2 Using Set
//O(n), O(n)
class CheckIfNAndItsDoubleExistSolution2 {
    public boolean checkIfExist(int[] arr) {
