...
class CheckIfTheSentenceIsPangramSolution1 {
...
//#2
//O(n), O(1)
class CheckIfTheSentenceIsPangramSolution2 {
    public boolean checkIfPangram(String sentence) {
...
//#3
//O(n), O(1)
class CheckIfTheSentenceIsPangramSolution3 {
    public boolean checkIfPangram(String sentence) {
...
//#4
//O(n), O(1)
class CheckIfTheSentenceIsPangramSolution4 {
    public boolean checkIfPangram(String sentence) {        
