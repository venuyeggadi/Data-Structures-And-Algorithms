...
//#1
//O(n^2), O(n)
class HowManyNumbersAreSmallerThanTheCurrentNumberSolution1 {
...
//#2
//O(nlogn), O(n)
class HowManyNumbersAreSmallerThanTheCurrentNumberSolution2 {
    public int[] smallerNumbersThanCurrent(int[] nums) {
...
*/ 
class HowManyNumbersAreSmallerThanTheCurrentNumberSolution3 {
    public int[] smallerNumbersThanCurrent(int[] nums) {
        int n = nums.length;
        int[] result = new int[n];
...
*/
class HowManyNumbersAreSmallerThanTheCurrentNumberSolution4 {
    public int[] smallerNumbersThanCurrent(int[] nums) {
        int n = nums.length;
        int[] result = new int[n];
