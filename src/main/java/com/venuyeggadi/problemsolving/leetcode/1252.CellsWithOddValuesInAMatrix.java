...
*/
class CellsWithOddValuesInAMatrixSolution1 {
...
Space : O(m+n)
*/
class CellsWithOddValuesInAMatrixSolution2 {
    public int oddCells(int m, int n, int[][] indices) {
        int[] rows = new int[m];
...
Space: O(m+n)
*/
class CellsWithOddValuesInAMatrixSolution3 {
    public int oddCells(int m, int n, int[][] indices) {
        int[] rows = new int[m];
        int[] columns = new int[n];
...
*/
class CellsWithOddValuesInAMatrixSolution4 {
    public int oddCells(int m, int n, int[][] indices) {
