package com.venuyeggadi.problemsolving.leetcode;/* Given an integer array nums, move all the even integers at the beginning
...
//O(n), O(1)
class SortArrayByParitySolution1 {
...
//#2
//O(n), O(1)
class SortArrayByParitySolution2 {
    public int[] sortArrayByParity(int[] nums) {
...
//#3
//O(n), O(1)
class SortArrayByParitySolution3 {
    public int[] sortArrayByParity(int[] nums) {
